...
<head>
    ...
    <title>JJTech Eagles Batch CI/CD Application Deployment! (A sample app for CodeDeploy)</title>
...
<body role="document">
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">JJTech Eagles Batch CI/CD Application Deployment</a>
      </div>
  ...
  <div class="container theme-showcase" role="main">
    ...
    <% } %>
    <div class="jumbotron">
      <h1>JJTech Eagles Batch CI/CD Application Deployment</h1>
